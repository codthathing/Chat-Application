...
from utils.types import UserDetailsFn, GroupsListFn
...
def enter_chat(userDetails: UserDetailsFn, user: User, groups_list: GroupsListFn, room: MultiChatRoom, group_name: str):
    message: str = input("\nNew message: ")
...
def add_group_member_action(userDetails: UserDetailsFn, user: User, groups_list: GroupsListFn, room: MultiChatRoom, group_name: str, username: str, action: Callable[[User, User], str], not_found_message: Callable[[str], str]) -> None:
...
def add_user(userDetails: UserDetailsFn, user: User, groups_list: GroupsListFn, room: MultiChatRoom, group_name: str):
    new_username: str = input("\nEnter new username: ")

    add_group_member_action(userDetails, user, groups_list, room, group_name, new_username, room.addUserToRoom, lambda name: f"\n@{name} not a user, can't add to group!",)

def add_admin(userDetails: UserDetailsFn, user: User, groups_list: GroupsListFn, room: MultiChatRoom, group_name: str):
    new_admin_username: str = input("\nEnter new admin username: ")

    add_group_member_action(userDetails, user, groups_list, room, group_name, new_admin_username, room.addRoomAdmin, lambda name: f"\n@{name} not a user!",)

def user_view_group_options(choice: int, userDetails: UserDetailsFn, user: User, groups_list: GroupsListFn, room: MultiChatRoom, group_name: str) -> None:
    match choice:
        case 1:
            enter_chat(userDetails, user, groups_list, room, group_name)
        case 2:
            add_user(userDetails, user, groups_list, room, group_name)
        case 3:
        ...
        case _:
            ...
            user_view_group_options(choice, userDetails, user, groups_list, room, group_name)

def user_view_group_admin_options(choice, userDetails: UserDetailsFn, user: User, groups_list: GroupsListFn, room: MultiChatRoom, group_name: str) -> None:
    match choice:
        case 1:
            enter_chat(userDetails, user, groups_list, room, group_name)
        case 2:
            add_admin(userDetails, user, groups_list, room, group_name)
        case 3:
            add_user(userDetails, user, groups_list, room, group_name)
        case 4:
            groups_list(user, userDetails, create_group, create_group_steps, group_chat_details, add_group_member_action)
        ...
        case _:
            ...
            user_view_group_admin_options(choice, userDetails, user, groups_list, room, group_name)

def determine_user_group_options(userDetails: UserDetailsFn, user: User, groups_list: GroupsListFn, room: MultiChatRoom, group_name: str) -> None:
...
def group_chat_details(userDetails: UserDetailsFn, user: User, groups_list: GroupsListFn, room: MultiChatRoom, group_name: str):
    ...
    determine_user_group_options(userDetails, user, groups_list, room, group_name)

def group_created_options(choice, userDetails: UserDetailsFn, groups_list: GroupsListFn, user: User, room: MultiChatRoom, group_name: str) -> None:
    match choice:
        case 1:
            group_chat_details(userDetails, user, groups_list, room, group_name)
        case 2:
        ...
        case _:
            ...
            group_created_options(choice, userDetails, groups_list, user, room, group_name)

def create_group_steps(user: User, userDetails: UserDetailsFn, groups_list: GroupsListFn, group_name: str):
    ...
    if group_users is not None:
        ...
        group_created_options(choice, userDetails, groups_list, user, multi_room, group_name)

def create_group(user: User, userDetails: UserDetailsFn, groups_list: GroupsListFn) -> None:
    group_name = input("\nEnter a group name: ")
